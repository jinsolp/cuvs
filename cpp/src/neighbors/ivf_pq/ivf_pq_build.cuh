...
//   raft::device_matrix_view<uint8_t, uint32_t, raft::row_major> out_codes,
//   raft::device_mdspan<const uint8_t, list_spec<uint32_t, uint32_t>::list_extents,
//   raft::row_major>
//     in_list_data,
...
//   run_on_list<PqBits>(in_list_data, offset_or_indices, out_codes.extent(0), pq_dim,
//   unpack_action);
// }
...
//   __device__ inline auto operator()(uint32_t i, uint32_t j) const -> uint8_t { return codes(i,
//   j); }
// };
